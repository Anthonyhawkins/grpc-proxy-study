...
message (	Rmessage"–
SecureEnvelope>
metadata (2".echo.SecureEnvelope.MetadataEntryRmetadata
type_url (	RtypeUrl
payload (Rpayload)
client_signature (RclientSignature'
proxy_signature (RproxySignature;
MetadataEntry
key (	Rkey
value (	Rvalue:82Š
EchoService2
	UnaryEcho.echo.EchoRequest.echo.EchoResponseG
BidirectionalStreamingEcho.echo.EchoRequest.echo.EchoResponse(02Œ
